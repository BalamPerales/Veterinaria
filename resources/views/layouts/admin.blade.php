...
<head>
    ...
    <meta name="description" content="Veterinaria — Panel de Administración">
    <meta name="author" content="">

    <title>@yield('titulo_pagina', 'Administración — Veterinaria')</title>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">@yield('page_title', 'Panel de Administración')</h1>
                        @yield('page_actions')
                    </div>
    ...
    {{-- ==================== LOGOUT MODAL ADMIN ==================== --}}
    @include('layouts.admin.partials.logout-modal')
    {{-- ==================== END LOGOUT MODAL ADMIN ==================== --}}
